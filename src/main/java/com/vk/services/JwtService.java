...
public class JwtService {
    ...
    @Value("${application.jwt.duration-in-minutes}")
    private Long jwtDurationInMinutes;
    ...
    private String generateToken(Map<String, Object> extraClaims, String subject) {
        return Jwts.builder().setClaims(extraClaims).setSubject(subject)
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * jwtDurationInMinutes))
